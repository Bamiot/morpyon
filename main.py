...
bt0 = Button(window, text="  ", command=clicked0, bg="light blue", height="10", width="20")
bt0.grid(column=0, row=0)
bt1 = Button(window, text="  ", command=clicked1, bg="light blue", height="10", width="20")
bt1.grid(column=1, row=0)
bt2 = Button(window, text="  ", command=clicked2, bg="light blue", height="10", width="20")
bt2.grid(column=2, row=0)
bt3 = Button(window, text="  ", command=clicked3, bg="light blue", height="10", width="20")
bt3.grid(column=0, row=1)
bt4 = Button(window, text="  ", command=clicked4, bg="light blue", height="10", width="20")
bt4.grid(column=1, row=1)
bt5 = Button(window, text="  ", command=clicked5, bg="light blue", height="10", width="20")
bt5.grid(column=2, row=1)
bt6 = Button(window, text="  ", command=clicked6, bg="light blue", height="10", width="20")
bt6.grid(column=0, row=2)
bt7 = Button(window, text="  ", command=clicked7, bg="light blue", height="10", width="20")
bt7.grid(column=1, row=2)
bt8 = Button(window, text="  ", command=clicked8, bg="light blue", height="10", width="20")
